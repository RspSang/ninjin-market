  ...
  return (
    <div>
      ...
      <div className="mb-3 flex cursor-pointer items-center space-x-3  border-b px-4 pb-3">
        ...
        <div>
          <p className="text-sm font-medium text-gray-700">パク</p>
      ...
      <div className="my-5 space-y-5 px-4">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <span className="block text-sm font-medium text-gray-700">lez</span>
            <span className="block text-xs text-gray-500 ">2時間前</span>
